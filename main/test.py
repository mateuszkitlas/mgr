...
class Test(IsolatedAsyncioTestCase):
    ...
    async def test_scorers(self):
        test_mols = test_data()
        total_time_per_score = Score[float](0., 0., 0., 0.)
        async with app_scorers as scorers:
            ...
            for test_mol, raw_score in zip(test_mols, raw_scores):
                ...
                total_time_per_score = timed_score.map_with(float, total_time_per_score, lambda a, b: a[0] + b)
        ...
        total_time = total_time_per_score.sa + total_time_per_score.sc + total_time_per_score.ra + total_time_per_score.syba
